...
幫助
<?php } else { ?>
<a href="misc.php?mod=faq">幫助</a><?php echo $navigation;?>
<?php } ?>
</div>
</div>
...
<div class="umh_act">
<p class="umh_cb" onclick="toggle_collapse('messageid<?php echo $faq['id'];?>', 1, 1);">[ 展開 ]</p>
</div>
</div>
...
<h1 class="mt mbm">關鍵字為「<span class="xi1"><?php echo $keyword;?></span>」的幫助</h1>
